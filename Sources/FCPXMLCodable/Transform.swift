...
public struct Transform: XMLRepresentable {
    ...
    public init(position: Point? = nil, scale: Point? = nil, rotation: Double? = nil, anchor: Point? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        scale = try container.decodeIfPresent(Point.self, forKey: .scale)
        rotation = try container.decodeIfPresent(Double.self, forKey: .rotation)
        anchor = try container.decodeIfPresent(Point.self, forKey: .anchor)
